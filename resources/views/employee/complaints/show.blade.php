...
@section('content')
    <div class="container-xxl py-4">
        <div class="mb-3">
            <a href="{{ route('employee.complaints.index') }}" class="text-decoration-none small">&larr; Back to complaints</a>
        </div>
        ...
        <div class="row g-3">
                ...
                @if ($complaint->employee_remarks)
                    <div class="card">
                        <div class="card-header py-2">
                            <h2 class="h6 mb-0">Your Remarks</h2>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('employee.complaints.update', $complaint) }}" class="small">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-2">
                                <label class="form-label form-label-sm">Your Remarks</label>
                                <textarea name="employee_remarks" rows="3"
                                          class="form-control form-control-sm">{{ old('employee_remarks', $complaint->employee_remarks) }}</textarea>
                            </div>
