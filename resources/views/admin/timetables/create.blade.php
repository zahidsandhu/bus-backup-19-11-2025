                ...
                <div id="timetable-details" style="display: none;">
                    ...
                    <div class="col-md-12">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="online_time_table" value="1" id="online_time_table" checked>
                            <label class="form-check-label" for="online_time_table">
