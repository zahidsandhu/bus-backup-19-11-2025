        ...
        <div class="col-xl-10 mx-auto">
            <div class="card discount-card">
                <div class="card-header-info">
                    <h5><i class="bx bx-plus-circle me-2"></i>Create New Discount</h5>
                </div>
                
                <form action="{{ route('admin.discounts.store') }}" method="POST" class="row g-3" id="discount-form">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <!-- Info Box -->
                        <div class="info-box">
                            <p><i class="bx bx-info-circle me-1"></i><strong>Tip:</strong> Enter complete discount information including type, value, validity period, and applicable platforms. This helps customers find and use the right discounts.</p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-text">Check this box to make the discount active immediately</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button type="submit" class="btn btn-primary px-4">
                                    <i class="bx bx-save me-1"></i>Create Discount
                                </button>
                            </div>
                        </div>
                    </div>
