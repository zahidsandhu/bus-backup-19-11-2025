        ...
        <div class="col-xl-10 mx-auto">
            <div class="card banner-card">
                <div class="card-header-info">
                    <h5><i class="bx bx-plus-circle me-2"></i>Create New Banner</h5>
                </div>
                ...
                <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data" class="row g-3">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Info Box -->
                        <div class="info-box">
                            <p><i class="bx bx-info-circle me-1"></i><strong>Tip:</strong> Enter complete banner information including title, type, and image. Each banner type has specific dimension requirements (Main: 1920x1080, Inner: 1200x600, Slider: 1920x800, Promotion: 800x600).</p>
                        </div>
